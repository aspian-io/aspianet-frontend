...
export const PostAgent = {
  ...
  blogNormalDetails: ( slug: string ): Promise<IPost> => apiRequests.get( `/posts/blogs/${ slug }` ),
  ...
  newsNormalDetails: ( slug: string ): Promise<IPost> => apiRequests.get( `/posts/news/${ slug }` ),
  ...
  pageNormalDetails: ( slug: string ): Promise<AxiosResponse<IPost>> => apiRequests.get( `/posts/pages/${ slug }` ),
