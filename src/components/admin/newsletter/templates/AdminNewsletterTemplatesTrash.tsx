...
const AdminNewsletterTemplatesTrash = () => {
  ...
  const fetcher = () =>
    AdminPostAgent.softDeletedNewsletterTemplatesList(session, page, limit);
  const {
    data: templatesData,
    error,
    mutate,
    ...
    <>
      <ConfirmModal
        ...
        onConfirm={async () => {
          try {
            ...
            await AdminPostAgent.emptyNewsletterTemplatesTrash(session);
            await mutate();
      ...
      <div className="flex flex-col justify-center items-center pb-4 space-y-4">
        <AdminTable
          ...
          pagination={{
            baseUrl: `${process.env.NEXT_PUBLIC_APP_BASE_URL}/admin/newsletter/templates/trash`,
...
export default AdminNewsletterTemplatesTrash;
