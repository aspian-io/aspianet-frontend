...
import { defaultTemplateDesign } from './default-template-design';
...
const AdminTemplateForm: FC<IProps> = ({
  editTemplateId,
  editTemplateData,
  minHeight = 850,
}) => {
                  ...
                  if (editTemplateId && editTemplateData) {
                    await AdminPostAgent.edit(
                      ...
                      new PostFormValues({
                        ...
                        type: PostTypeEnum.NEWSLETTER_TEMPLATE,
                    ...
                    router.push(
                      `/admin/newsletter/templates/edit/${template.id}`
                    );
                  }
                } catch (error) {
                  setSubmitting(false);
