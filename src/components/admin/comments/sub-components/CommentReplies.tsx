    ...
    <>
      ...
      >
        <ConfirmModal
          ...
          onConfirm={async () => {
            try {
              ...
              if (itemToDelete) {
                ...
                await mutate();
                setItemToDelete(null);
                toast.success('The reply moved to trash.', {
          ...
          text="Are you sure you want to delete the reply?"
        />
      </AuthGuard>
      {!repliesData && (
        ...
        repliesData.map((r, i) => (
          ...
          >
            ...
            <div className="text-xs text-zinc-600 mb-1">
              {moment(r.createdAt).format('MMM Do YYYY, h:mm:ss a')}
            </div>
            {!edit && (
              <div className="text-sm text-zinc-700 mt-4">{r.content}</div>
            )}
            {edit && (
                ...
                <Formik
                  ...
                  onSubmit={async (values, { resetForm }) => {
                    try {
                      ...
                      await mutate();
                      setEdit(false);
                      toast.success('The reply modified successfully.', {
            ...
            <div className="flex flex-row justify-start items-center space-x-8 mt-4">
              <div className="flex justify-center items-center text-primary text-xs">
                <svg
                ...
                <div className="ml-2">{r.likesNum}</div>
              </div>
              <div className="flex justify-center items-center text-primary text-xs">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <div className="ml-2">{r.dislikesNum}</div>
              </div>
              <AuthGuard
