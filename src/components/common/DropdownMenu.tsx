...
const DropdownMenu: IDropdownMenu = ({ className, children }) => {
  ...
  return (
    <div className={`relative ${className} mb-6`}>
      ...
      <div
        ...
        } flex flex-col min-w-[100px] absolute drop-shadow top-9 right-0 p-2 text-zinc-500 z-40 bg-light text-sm rounded-xl transition-all duration-300`}
      >
        {children}
      </div>
    </div>
