...
const UnsubscribeConfirmationPage: NextPage<IProps> = ({
  email,
  remainingTime,
}) => {
  ...
  return (
    <>
      <Head>
        <meta charSet="utf-8" />
        <title>Newsletter Unsubscribe Confirmation</title>
      ...
      <Formik
        ...
        onSubmit={async (values, { resetForm }) => {
          try {
            await NewsletterAgent.unsubscribe(
            ...
            setDone(true);
            toast.success(
              'You unsubscribed from our newsletter successfully. Redirecting to the homepage ...',
              {
                    ...
                    <div className="flex justify-center items-center w-full my-5">
                      <div className="relative text-center">
                        ...
                        <p className="text-dark text-xs sm:text-sm mt-8 text-left">
                          ...
                          to your email for unsubscribe confirmation.
                        </p>
                      </div>
                    </div>
